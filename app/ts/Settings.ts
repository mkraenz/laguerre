class Settings {
    public static MAX_REGION_IN_POSITIVE_X_DIRECTION: number = 4;
    public static MAX_REGION_IN_POSITIVE_Y_DIRECTION: number = 4;
    public static MAX_REGION_IN_POSITIVE_Z_DIRECTION: number = 4;

    public static MAX_REGION_IN_NEGATIVE_X_DIRECTION: number = 4;
    public static MAX_REGION_IN_NEGATIVE_Y_DIRECTION: number = 4;
    public static MAX_REGION_IN_NEGATIVE_Z_DIRECTION: number = 4;
