class Settings {
    ...
    public static MAX_REGION_IN_POS_Y_DIR: number = 4;
    public static MAX_REGION_IN_POS_Z_DIR: number = 4;

    public static MAX_REGION_IN_NEG_X_DIR: number = 1;
    public static MAX_REGION_IN_NEG_Y_DIR: number = 3;
    public static MAX_REGION_IN_NEG_Z_DIR: number = 4;
    ...
    public static PROJECTION_POINT_Y_VALUE: number = 10;
